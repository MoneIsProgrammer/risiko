...
Il software vuole essere un mockup di risiko utilizzando come riferimento il manuale fornito da ludolega.it \footnote{\url{http://www.ludolega.it/media/Risiko_Prestige.pdf}} ignorando per semplicità le regole da torneo.
...
Durante una partita i giocatori possono consultare il tabellone che contiene continenti che a loro volta sono composti dai vari territori che contengono le armate posizionate da ciascun giocatore.
\newline Ogni giocatore dispone di una propra mano, ovvero delle carte fornite dal mazzo composto da queste ultime.
\newline I giocatori che possono essere umani o aventi un ai, entrambi generano degli eventi a seguito delle loro azioni
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{latex/resources/ModelloDominio.png}
    \caption{Caption}
