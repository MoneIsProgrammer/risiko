...
/**
 * The general implementation of a Player, gives the general methods for the basic actions and methods to ease the implementation of human and bot Players.
 * It's designed so that each player behavior is differentiated by the Strategy Pattern, meaning for each different behavior and external {@link PlayerStrategy} implementation is required 
 */
